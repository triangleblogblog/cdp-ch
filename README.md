...
[![Infrastructure Deployment Status](https://github.com/triangleblogblog/cdp-ch/workflows/Infrastructure/badge.svg)](https://github.com/triangleblogblog/cdp-ch/actions?query=workflow%3A%22Infrastructure%22)
[![Event Processing Pipeline](https://github.com/triangleblogblog/cdp-ch/workflows/Event%20Gather/badge.svg)](https://github.com/triangleblogblog/cdp-ch/actions?query=workflow%3A%22Event+Gather%22)
[![Event Index Pipeline](https://github.com/triangleblogblog/cdp-ch/workflows/Event%20Index/badge.svg)](https://github.com/triangleblogblog/cdp-ch/actions?query=workflow%3A%22Event+Index%22)
[![Web Deployment Status](https://github.com/triangleblogblog/cdp-ch/workflows/Web%20App/badge.svg)](https://triangleblogblog.github.io/cdp-ch)
[![Repo Build Status](https://github.com/triangleblogblog/cdp-ch/workflows/Build%20Main/badge.svg)](https://github.com/triangleblogblog/cdp-ch/actions?query=workflow%3A%22Build+Main%22)
...
This repo serves the municipality: **Chapel Hill**
...
fireo.connection(client=Client(
    project="cdp-chapel-hill-pulvuoxc",
...
fs = GCSFileSystem(project="cdp-chapel-hill-pulvuoxc", token="anon")
...
in the
[admin-docs directory](https://github.com/triangleblogblog/cdp-ch/tree/main/admin-docs).
