...
[Event Gather GitHub Action Page](https://github.com/triangleblogblog/cdp-ch/actions/workflows/event-gather-pipeline.yml).
...
[Process Special Event GitHub Action Page](https://github.com/triangleblogblog/cdp-ch/actions/workflows/process-special-event.yml).
